    ...
    public void buttonA(View view) {
        ...
        if (currentQuestion.getOptA().equals(currentQuestion.getAnswer())) {
            ...
            //If user has exceeds the que limit just navigate him to GameWon activity
              ...
              //  gameWon();
                Toast.makeText(currentQuestion, "GameWon", Toast.LENGTH_SHORT).show();
        ...
        //User ans is wrong then just navigate him to the PlayAgain activity
            ...
            gameLostPlayAgain();
           // Toast.makeText(currentQuestion, "GameLost", Toast.LENGTH_SHORT).show();
  ...
  //  public void gameWon() {
   ...
   /* public void timeUp() {
    ...
    public void correctDialog() {
        final Dialog dialogCorrect = new Dialog(gameQuiz.this);
